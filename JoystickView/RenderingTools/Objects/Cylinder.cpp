...
void RT::Cylinder::Draw(CanvasWrapper canvas, Frustum &frustum, int segments, float roationAnchorPoint) const
{
	...
	for(size_t i = 0; i != circlePoints.size(); ++i)
	{
		...
		bottom.Z -= (height * roationAnchorPoint);
		top.Z += (height * float(1.f - roationAnchorPoint));
